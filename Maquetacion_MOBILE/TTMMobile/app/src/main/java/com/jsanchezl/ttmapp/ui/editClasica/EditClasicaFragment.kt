...
import com.jsanchezl.ttmapp.databinding.FragmentEditClasicaBinding
import com.jsanchezl.ttmapp.ui.editClasica.EditCViewModel


class EditClasicaFragment: Fragment(){

    private var _binding: FragmentEditClasicaBinding? = null
    ...
    override fun onCreateView(
        ...
        val homeViewModel = ViewModelProvider(this).get(EditCViewModel::class.java)
        _binding = FragmentEditClasicaBinding.inflate(inflater, container, false)
