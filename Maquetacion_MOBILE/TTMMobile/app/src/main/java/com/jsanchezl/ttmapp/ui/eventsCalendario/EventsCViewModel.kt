...
import com.jsanchezl.ttmapp.ui.eventsCalendario.EventsCViewModel
import org.json.JSONObject

class EventsCViewModel (application: Application) :  AndroidViewModel(application) {
    ...
    class Factory(val app: Application) : ViewModelProvider.Factory {
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            if (modelClass.isAssignableFrom(EventsCViewModel::class.java)) {
                @Suppress("UNCHECKED_CAST")
                return EventsCViewModel(app) as T
            }
